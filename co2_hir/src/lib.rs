...
pub use item::{
    HirBody, HirLabel, HirLocal, LabelId, LocalId, build_forwarding_fn_body,
    eval_usize_initializer, infer_array_len_from_initializer, lower_function_body,
    lower_static_body, lower_static_body_for_ty,
};
